...
- 🔭 Working on research projects with **Machine Learning**, **Data Science**, **Software Engineering** tags
- 🌱 Learning **Natural Language Processing** ~and Web Application Frameworks **(Django, React)**~
